        ...
        rest("auth" )
                ...
                .process(new Processor() {
                    ...
                    public void process(Exchange exchange) throws Exception {
                        if (discoveryClient == null || discoveryClient.getInstances("ms-oauth").size() <= 0)
                            return;
                        ...
                        String postData = MessageFormat.format("username={0}&password={1}&grant_type={2}",
                                headers.get("username") != null && !headers.get("username").isEmpty()? headers.get("username") : "",
                                headers.get("password") != null && !headers.get("password").isEmpty()? headers.get("password") : "",
                                headers.get("grant_type") != null && !headers.get("grant_type").isEmpty()? headers.get("grant_type") : "");
